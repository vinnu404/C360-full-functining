		...
		<div class="container">
			<div class="row ">
				<div class="col-md-3 col-sm-3">
					<Link to="/"> <img src="images/logo.png" alt="C360soft" title="C360soft" class="logo stickylogo" width="auto" height="auto"/> <img src="images/logowhite.png" alt="C360soft" title="C360soft" class="logo staticlogo" width="auto" height="auto"/></Link>
				</div>
					...
					<div class="collapse nav navbar-collapse" id="navbar-collapse">
					  <ul class="mainmenu ">
						...
						<li class=""><Link to="#" class="">Industries <i class="fa fa-angle-down" aria-hidden="true"></i> </Link>
							<div class="submenu" style={{display: 'none', height: '174px', 'paddingtop': '30px', margintop: '0px', paddingbottom: '30px', marginbottom: '0px'}}>
								<div class="container">
								  <div class="row">
									<div class="col-md-3">
									  <ul>
